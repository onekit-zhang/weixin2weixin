module.exports = (function(modules){
    ...
    function(module,exports,__webpack_require__){
        ...
        function unlinked(target){
            if(target.data.prop){
                deletethis.data.formItems[target.data.prop];
            }
        };
        Component({
            properties:{
            ...
            methods:{
                ...
                _modelChange:function(newVal,oldVal,path){
                    var _this = this;
                    if(!this.isInit){
                        this.isInit = true;
                        return newVal;
                    ...
                    if(diffObj){
                        (function(){
                            ...
                            _this.triggerEvent(isValid?'success':'fail',isValid?{
                                trigger:'change'
                            }:{
                                errors:errors,
                                trigger:'change'
                ...
                validate:function(cb){
                    ...
                    return this.formValidator.validate(function(isValid,errors){
                        ...
                        _this2.triggerEvent(isValid?'success':'fail',isValid?{
                            trigger:'validate'
                        }:{
                            errors:handleError,
                            trigger:'validate'
                ...
                validateField:function(name,value){
                    ...
                    return this.formValidator.validateField(name,value,function(isValid,errors){
                        ...
                        _this3.triggerEvent(isValid?'success':'fail',isValid?{
                            trigger:'validate'
                        }:{
                            errors:handleError,
                            trigger:'validate'
    ...
    function(module,exports,__webpack_require__){
        ...
        var FormValidator = (function(){
            ...
            FormValidator.prototype.validate = function(cb){
                ...
                return new Promise(function(resolve){
                    ...
                    keys.forEach(function(key){
                        if(!errors[key])deleteerrors[key]
                    });
                    resolve({
                        isValid:!failCount,
            ...
            FormValidator.prototype.validateField = function(name,value){
                ...
                return new Promise(function(resolve){
                    _this2._innerValidateField(name,value,function(valid,error){
                        ...
                        if(errorChanged){
                            if(!error)delete_this2.errors[name]
            ...
            FormValidator.prototype.addMethod = function(ruleName,method){
    ...
    function(module,exports,__webpack_require__){
        ...
        exports.default = {
            ...
            email:function(r,value){
                ...
                if(!new RegExp("^((([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+(\.([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+)*)|((\x22)((((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(([\x01-\x08\x0b\x0c\x0e-\x1f\x7f]|\x21|[\x23-\x5b]|[\x5d-\x7e]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(\\([\x01-\x09\x0b\x0c\x0d-\x7f]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]))))*(((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(\x22)))@((([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.)+(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))$","i").test(value)){
                    return string_1.sprintf(r.message || defaultMessage.email);
                }
            },
            url:function(r,value){
                if(r.url === false)return
                if(!new RegExp("^(https?|s?ftp|weixin):\/\/(((([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:)*@)?(((\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5])\.(\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5])\.(\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5])\.(\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5]))|((([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.)+(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.?)(:\d*)?)(\/((([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:|@)+(\/(([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:|@)*)*)?)?(\?((([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:|@)|[\uE000-\uF8FF]|\/|\?)*)?(#((([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:|@)|\/|\?)*)?$","i").test(value)){
            ...
            bytelength:function(r,value,param,models){
                param = r.param;
                var len = value.replace(new RegExp("[^\x00-\xff]","g"),'**').length;
